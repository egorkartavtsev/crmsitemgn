      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            ...
            <li>Совместимость: <?php echo $comp; ?></li>
            <li>Состояние: <?php echo $condition; ?></li>
            <li>Примечание:<br> <?php echo $note; ?></li>
            <?php if ($reward) { ?>
                        ...
                        <form method='POST' action="">
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name='mark' placeholder="Марка Вашего авто...">
                            </div>
                            <div class="form-group">
                              <label >Модель автомобиля: </label>
                              <input type="text" class="form-control" name='model' placeholder="Модель вашего авто...">
                            </div>
                            <div class="form-group">
